...
CREATE TYPE "public"."ai_provider" AS ENUM('anthropic', 'openai', 'ollama');--> statement-breakpoint
...
CREATE TYPE "public"."proposal_status" AS ENUM('pending', 'merged', 'accepted', 'rejected');--> statement-breakpoint
...
CREATE TYPE "public"."source_type" AS ENUM('pdf_digital', 'pdf_scanned', 'photo', 'image');--> statement-breakpoint
CREATE TYPE "public"."usage_kind" AS ENUM('extract_page', 'answer_derive', 'classify', 'explain');--> statement-breakpoint
...
CREATE TABLE "users" (
	...
	"ai_tier" "ai_tier" DEFAULT 'trial' NOT NULL,
	"trial_pages_used" integer DEFAULT 0 NOT NULL,
...
ALTER TABLE "topic_proposals" ADD CONSTRAINT "topic_proposals_suggested_parent_id_topics_id_fk" FOREIGN KEY ("suggested_parent_id") REFERENCES "public"."topics"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "topic_proposals" ADD CONSTRAINT "topic_proposals_source_question_id_questions_id_fk" FOREIGN KEY ("source_question_id") REFERENCES "public"."questions"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "topic_proposals" ADD CONSTRAINT "topic_proposals_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "topic_proposals" ADD CONSTRAINT "topic_proposals_merged_into_topic_id_topics_id_fk" FOREIGN KEY ("merged_into_topic_id") REFERENCES "public"."topics"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "topic_proposals_status_idx" ON "topic_proposals" USING btree ("status");--> statement-breakpoint
CREATE INDEX "topic_proposals_embedding_idx" ON "topic_proposals" USING hnsw ("embedding" vector_cosine_ops);--> statement-breakpoint
...
CREATE INDEX "worksheets_user_created_idx" ON "worksheets" USING btree ("user_id","created_at");